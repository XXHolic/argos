 ...
 * @hidden
 */
export function exceptionFromStacktrace(stacktrace: TraceKitStackTrace) {
 ...
 * @hidden
 */
export function eventFromPlainObject(exception: {}, syntheticException?: Error, rejection?: boolean) {
  const event = {
    exception: {
      values: [
        {
